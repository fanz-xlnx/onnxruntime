...
MatMulBnb4 is a MatMul with weight quantized with 4 bits using either FP4 or NF4 data type (https://arxiv.org/pdf/2305.14314.pdf). It does Matrix Multiplication like MatMul (https://github.com/onnx/onnx/blob/main/docs/Operators.md#matmul) with differences:
  ...
  ONNX_CONTRIB_OPERATOR_SCHEMA(QuantNbitsLinear)
      .SetDomain(kMSDomain)
      .SinceVersion(1)
      .SetDoc(R"DOC()DOC")
      .Attr("outfeatures", "function name generated by AOT compiler", AttributeProto::INT, OPTIONAL_VALUE)
      .Attr("infeatures", "function name generated by AOT compiler", AttributeProto::INT, OPTIONAL_VALUE)
      .Attr("bits", "function name generated by AOT compiler", AttributeProto::INT, OPTIONAL_VALUE)
      .Attr("groupsize", "function name generated by AOT compiler", AttributeProto::INT, OPTIONAL_VALUE)
      .Input(0, "X1", "The input tensor", "T")
      .Input(1, "qweight", "", "T1", OpSchema::Optional)
      .Input(2, "scales", "input 'X'.", "T", OpSchema::Optional)
      .Input(3, "zero_points", "input 'X'.", "T1", OpSchema::Optional)
      .Input(4, "bias", "input 'X'.", "T", OpSchema::Optional)
      .Input(5, "group_idx", "input 'X'.", "T1", OpSchema::Optional)
      ...
      .TypeAndShapeInferenceFunction([](ONNX_NAMESPACE::InferenceContext& ctx) {
        ...
        // const ONNX_NAMESPACE::TensorShapeProto& input_shape1 = ctx.getInputType(1)->tensor_type().shape();
